...
public class EnvioClienteService 
{
    ...
    // CÓMO: arma el DTO y lo manda por POST. Va en try/catch para ser RESILIENTE:
    ...
    public void notificarPagoConfirmado(Long idPedido) {
        try 
        {
            ...
            System.out.println("No se pudo notificar a MS Envios (se reintentará): " + e.getMessage());
        }
    }
}